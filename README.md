...
Ce dépôt est un fork du dépôt TNAH_FILM_DB ([GitHub - LauryneL/TNAH_FILM_DB: Generate a database from data bulk](https://github.com/LauryneL/TNAH_FILM_DB)) et a été réalisé dans le cadre d'un projet de groupe du M2 TNAH par Léticia Mvogo, Charline Emiry, Neïla Hamoudi et Arthur Douilly, lesquels sont responsables de la création des scripts SQL et de l'anonymisation des données.
